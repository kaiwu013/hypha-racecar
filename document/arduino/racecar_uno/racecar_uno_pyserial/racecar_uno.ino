...
void loop() {
    if (Serial.available()) {
      ...
      int out_1 = getValue(commad_string, ',', 0).toInt(); //getValue func should be removed (TBD) 
      int out_2 = getValue(commad_string, ',', 1).toInt();
     // int out_3 = getValue(commad_string, ',', 2).toInt();
